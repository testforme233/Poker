...
const EggGameManager = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-6">年会惯蛋比赛管理系统</h1>
...
const TeamManagement = ({ teams, setTeams }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mt-4">
        {teams.map(team => (
          <div key={team.id} className="flex items-center justify-between border p-2 mb-2">
            <div>
    ...
    <div>
      ...
      <div className="grid gap-4" style={{
        ...
        {seating.tables.map((table, index) => (
          <div key={index} className="border p-4 bg-gray-100 relative">
      ...
      <div className="mt-4">
        <h3 className="font-bold mb-2">待分配队伍</h3>
    ...
    <div>
      ...
      <div className="space-y-2">
        {rankedTeams.map((team, index) => (
          <div
            key={team.id}
            className={`p-4 rounded ${getBackgroundColor(index)}`}
          >
